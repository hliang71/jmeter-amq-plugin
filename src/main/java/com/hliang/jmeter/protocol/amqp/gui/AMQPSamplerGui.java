...
public abstract class AMQPSamplerGui extends AbstractSamplerGui {
    ...
    protected JLabeledTextField routingKey = new JLabeledTextField("Binding Key");
    ...
    private Component makeCommonPanel() {
        ...
        exchangeQueueSettings.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Consumer Setting"));
